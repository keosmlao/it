-- 009_asset_registered_at.sql
-- ເພີ່ມເວລາລົງທະບຽນຊັບສິນ (as_asset.create_date_time_now) ເຂົ້າ view
-- ເພື່ອໃຫ້ຮູ້ວ່າເຄື່ອງເຂົ້າທະບຽນເມື່ອໃດ ແລະ ຮຽງລຳດັບຕາມນັ້ນໄດ້

-- `create or replace` ແຊກຄໍລຳກາງບໍ່ໄດ້ — ຕ້ອງ drop ກ່ອນ
-- (v_asset_movements ບໍ່ໄດ້ອີງ view ນີ້ ຈຶ່ງບໍ່ກະທົບ)

-- 020_asset_active_flag.sql
-- ເພີ່ມ is_active ເຂົ້າ view ອຸປະກອນ
--
-- as_asset.status: 0 = ໃຊ້ງານ, ນອກນັ້ນ = ປົດລະວາງ/ຢຸດໃຊ້
-- (ພົບ 2 ເຄື່ອງ status = 1) — ບໍ່ຄວນເອົາມາໃຫ້ຢືມອີກ
...
select a.code                                   as asset_code,
       ...
       coalesce(a.status, 0) = 0                as is_active,

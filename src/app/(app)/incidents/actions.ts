...
export async function createIncident(
  ...
  if (!can.menu(user, '/incidents/new', 'create')) return { error: 'ບໍ່ມີສິດບັນທຶກເຫດຂັດຂ້ອງ' }
...
export async function updateIncident(
  ...
  const user = await requireUser()
  if (!can.menu(user, '/incidents', 'edit')) return { error: 'ບໍ່ມີສິດແກ້ເຫດຂັດຂ້ອງ' }
...
export async function resolveIncident(
  ...
  const user = await requireUser()
  if (!can.menu(user, '/incidents', 'edit')) return { error: 'ບໍ່ມີສິດປິດເຫດຂັດຂ້ອງ' }

  ...
  },
  {
    ...
    items: [
      ...
      { href: '/reports', label: 'ລາຍງານ', icon: ICON.chart, visible: can.viewReports },
      {
        ...
        label: 'ຕັ້ງຄ່າລະບົບ',
        icon: ICON.settings,
        visible: (u) => can.viewMenu(u, '/admin'),
        children: [
          {
            href: '/admin/sla',
            label: 'SLA',
            icon: ICON.clock,
            visible: (u) => can.viewMenu(u, '/admin/sla'),
          },
          {
            href: '/admin/categories',
            label: 'ປະເພດບັນຫາ',
            icon: ICON.ticket,
            visible: (u) => can.viewMenu(u, '/admin/categories'),
          },
          {
            href: '/admin/permissions',
            label: 'ຈັດການສິດ',
            icon: ICON.key,
            visible: (u) => can.viewMenu(u, '/admin/permissions'),
          },
          {
            href: '/admin/purchase-steps',
            label: 'ຂັ້ນຕອນອະນຸມັດ PR',
            icon: ICON.request,
            visible: (u) => can.viewMenu(u, '/admin/purchase-steps'),
          },
          {
            href: '/admin/line',
            label: 'ແຈ້ງເຕືອນ LINE',
            icon: ICON.bell,
            visible: (u) => can.viewMenu(u, '/admin/line'),
          },
          {
            href: '/admin/emails',
            label: 'ອີເມວແຈ້ງເຕືອນ',
            icon: ICON.bell,
            visible: (u) => can.viewMenu(u, '/admin/emails'),
          },
          {
            href: '/admin/security',
            label: 'ກວດຄວາມປອດໄພ',
            icon: ICON.warning,
            visible: (u) => can.viewMenu(u, '/admin/security'),
          },
          {
            href: '/admin/audit',
            label: 'ບັນທຶກການປ່ຽນແປງ',
            icon: ICON.clock,
            visible: (u) => can.viewMenu(u, '/admin/audit'),
          },
        ],
      },
    ],
...
export const PAGE_TITLES: Record<string, string> = {
  ...
  '/admin/sla': 'SLA',
  '/admin/categories': 'ປະເພດບັນຫາ',
  '/admin/permissions': 'ຈັດການສິດ',
  '/admin/purchase-steps': 'ຂັ້ນຕອນອະນຸມັດ PR',
  '/admin/line': 'ແຈ້ງເຕືອນ LINE',
  '/admin/audit': 'ບັນທຶກການປ່ຽນແປງ',
